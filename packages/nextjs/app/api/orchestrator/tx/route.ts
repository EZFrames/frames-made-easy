...
import { FrameTransactionResponse } from "@coinbase/onchainkit/lib/frame/types";
...
const contract = "0x059ee9bde2aff94d0e6ad396ec0ec7d27bff6dc8";
const myAddress = "0x027fe3f132403c1b59ddaba14b576d15865f69c0"
export async function POST(req: NextRequest): Promise<NextResponse<FrameTransactionResponse>> {
  const callData = encodeFunctionData({
    abi: ABI,
    functionName: "trf",
    args: [myAddress, parseEther('5'), BigInt(1)],
  });
